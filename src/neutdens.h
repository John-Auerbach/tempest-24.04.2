...
int use_nrlmsis = FALSE ;
char  nrlmsis_datafile [256] = "" ;
...
struct PARAMETERS neutdens_param_list [] =
{
   {"PREFER_MSISE90", P_BOOL , &neutdens_prefer_msise_90,
    ...
    ,{"USE_NRLMSIS"   , P_BOOL , &use_nrlmsis,
        "Use precomputed NRLMSIS datafile instead of MSIS/MSISE (Yes/No)"},
    {"NRLMSIS_DATAFILE", P_STR, nrlmsis_datafile,
        "Path to CSV datafile generated by tools/gen_nrlmsis_table.py"}
} ;
...
extern int    use_nrlmsis ;
extern char   nrlmsis_datafile [] ;
